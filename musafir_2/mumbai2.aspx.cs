...
namespace musafir_2
{
    public partial class mumbai2 : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select hotel , meal from itinerary_final where i_name= 'mumbai to mandwa speed boat service' ", con);
