...
namespace musafir_2
{
    public partial class munnar_sightseeing : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select hotel , meal from itinerary_final where i_name= '3 days munnar sightseeing package' ", con);
