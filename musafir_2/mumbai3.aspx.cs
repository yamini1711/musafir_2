...
namespace musafir_2
{
    public partial class mumbai3 : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select hotel , meal from itinerary_final where i_name= 'bollywood tour with city tour' ", con);
