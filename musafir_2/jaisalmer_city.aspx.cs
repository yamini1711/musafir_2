...
namespace musafir_2
{
    public partial class jaisalmer_city : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select hotel , meal from itinerary_final where i_name= 'padharo jaisalmer tour' ", con);
