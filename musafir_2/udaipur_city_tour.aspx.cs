...
namespace musafir_2
{
    public partial class udaipur_city_tour : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select hotel , meal from itinerary_final where i_name= 'udaipur city tour' ", con);
