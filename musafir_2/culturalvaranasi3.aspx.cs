...
namespace musafir_2
{
    public partial class culturalvaranasi3 : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select hotel , meal from itinerary_final where i_name= 'cultural walk tour of varanasi' ", con);
