...
namespace musafir_2
{
    public partial class thiru1 : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select hotel , meal from itinerary_final where i_name= 'tour of thriuvananthapuram in kerla' ", con);
