...
namespace musafir_2
{
    public partial class nanital1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("select hotel , meal from itinerary_final where i_name= 'nainital weekned tour ' ", con);
