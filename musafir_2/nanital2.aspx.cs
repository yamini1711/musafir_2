...
namespace musafir_2
{
    public partial class nanital2 : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select hotel , meal from itinerary_final where i_name= 'jim corbett and nainital tour from delhi' ", con);
