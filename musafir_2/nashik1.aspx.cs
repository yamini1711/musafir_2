...
namespace musafir_2
{
    public partial class n1 : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select hotel , meal from itinerary_final where i_name= 'alang madan kulang trek' ", con);
