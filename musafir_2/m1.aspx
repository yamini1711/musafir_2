<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="m1.aspx.cs" Inherits="musafir_2.m1" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="h_main">
          ...
          <div class="outer-div">
            <div class="inner-div">
                <h1>Mussoorie Tour Package Highlights</h1>
                <ul>
                    <li>Get captivated by the scenic views offered by the Queen of Hills -
                        Mussoorie, a hill station that inspired writers like Ruskin Bond</li>
                    <li>Sit leisurely by the cascading Kempty falls, which once served as a tea
                        party spot for Britishers.</li>
                    <li>Enchanting view from Snow View Point by cable car from where one can see
                        the glittering range of the mighty Himalayas.</li>
                    <li>Experience the varied flora and fauna, green hills, fascinating hill resorts and picturesque valleys..</li>
                    <li>Get your adrenaline rushing by indulging in adventure activities like trekking, angling, hiking, paragliding, zip lining in Mussoorie.<li />
                    <li>Experience a thrilling trek to Robber's Cave, a rustic wonder where you can put your legs in the water while having snacks from the nearby restaurants.</li>
                </ul>
            </div>
            <div class="inner-div1">
                <h2>Mussoorie Tour Package Overview</h2>
                 <p class="content"><strong><u> About the Tour:</u></strong></p>
                <p class="content1">Celebrate the romantic milestones in your life with your
                    soulmate to the enigmatic destinations surrounded with snow-covered mountains,
                    wooded deodar forests, apple orchards, wild colorful flowers, verdant landscapes
                    , and the tumbling Beas River.

                    Loosen yourself in the exotic beauty of nature as you go on this 3-day
                    Mussoorie tour. Visit the most popular places here and discover the reason
                    behind Mussoorie being one of the most beautiful places in the country. Embark
                    the tour from Delhi to Queen of Hills - “Mussoorie” eye witnessing the beautiful
                    Kempty Falls, Company garden, Happy valley and the mesmerizing view from the
                    highest point - Clouds End in Mussoorie.</p>
                <p class="content2"><strong><u>Quick Info:</u></strong></p>
                <ul>
                    <li><strong>Route: </strong>Delhi - Mussoorie - Delhi</li>
       ...
       <div class="accordian">
           ...
           <div class="contentbox">
                <div class="label1">DAY 1 <h7 style="font-size:18px";><strong>Delhi to Mussoorie | Drive Through the Scenic Trails to the 'Queen of Hills'</strong></h7></div>
               <div class="content" >
                   <ul>
           ...
           <div class="contentbox">
                <div class="label1"> DAY 2: <h8 style="font-size:18px";><strong>Sightseeing in Mussoorie | Witness the somersault of the milky streams from the Gigantic Kempty Waterfalls</strong></h8></div>
               <div class="content">
                   <ul>
           ...
           <div class="contentbox">
                <div class="label1">DAY 3: <h8 style="font-size:18px";><strong>Departure from Mussoorie to Delhi | It's time to say Goodbye</strong></h8></div>
               <div class="content">
                   <ul>
            ...
            <div class="textbox">
                ...
                <div class="text">
                   <!-- <h14><strong><u>Price Includes</u></strong></h14>
                    ...
                    <asp:GridView ID="GridView1" runat="server" Width="425px"></asp:GridView>
        <script>
