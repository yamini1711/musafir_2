...
namespace musafir_2
{
    public partial class halfday_jaisalmer : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select hotel , meal from itinerary_final where i_name= 'halfday camel safari' ", con);
