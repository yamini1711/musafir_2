...
namespace musafir_2
{
    public partial class udaipur_jodhpur : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select hotel , meal from itinerary_final where i_name= 'udaipur jodhpur' ", con);
