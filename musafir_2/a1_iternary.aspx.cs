...
namespace musafir_2
{
    public partial class a1_iternary : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select hotel , meal from itinerary_final where i_name= 'camping in auli' ", con);
