<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="p3.aspx.cs" Inherits="musafir_2.p3" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="outer-div">
            ...
            <div class="inner-div1">
                ...
                <ul>
                    <p class="auto-style1" style="padding:17px;">This heritage property sprawling 25 acres of lush greenery is an amazing destination to enjoy a fun day out with your family and friends. Being a converted 18th-century fort, the property offers a wonderful historic vibe amidst tall trees and dense green landscapes in Pune.
...
Take a break and unwind yourself on this fun and exciting day out at a heritage fort hotel in Pune. With delicious meals, shooting, adventure activities, outdoor games, and etc you are guaranteed a fun time along with your companions.</p>
                ...
                <h5><strong><u>How to Reach:</u></strong></h5>
                    ...
                    <p style="padding17px;"><br />The activity location is 26.1 km from the Pune city center and one can easily access the destination using a public or a private mode of transportation.</p>
                <ul>    
...
TOUR PACKAGE</strong> <button style="margin-left:20px;" type="submit" formaction="bill2.aspx" class ="b">BOOK</button>
                ...
                <!--    <h14><strong><u>&nbsp; Price Includes</u></strong></h14>
                    <ul>
                        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Indulge in an exciting day out with your family and friends with the help of exciting activities and&nbsp;&nbsp;&nbsp;&nbsp; delicious meals.</li>
                ...
                <div class="textbox">
                <div class="label"><strong>Day Picnic Without Breakfast</strong><button style="margin-left:20px;">BOOK</button>
                    <h13 style="margin-left:40%;"></h13>
                </div>
                <div class="text">
                ...
                <div class="text">
                    ...
                    <asp:GridView ID="GridView1" runat="server" Width="363px"></asp:GridView>     
        <script>
