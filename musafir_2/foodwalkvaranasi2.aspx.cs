...
namespace musafir_2
{
    public partial class foodwalkvaranasi2 : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select hotel , meal from itinerary_final where i_name= 'varanasi food walk tour' ", con);
