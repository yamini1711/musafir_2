...
namespace musafir_2
{
    public partial class halfdayvaranasi4 : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select hotel , meal from itinerary_final where i_name= 'halfday sarnath tour from varanasi' ", con);
