...
namespace musafir_2
{
    public partial class fatehpuragra4 : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select hotel , meal from itinerary_final where i_name= 'fatehpur sikri fort itinerary' ", con);
