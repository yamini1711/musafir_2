<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jaipur_pushkar.aspx.cs" Inherits="musafir_2.jaipur_pushkar" %>
    ...
    <form id="form1" runat="server">
                ...
                <div class="nav-bar flex space-between align-center">
                    ...
                    <div class="nav-links">
                        <ul class="flex f-w-600">
                            <li style="white-space:normal;"><a href="home.aspx">HOME</a></li>
                            <li style="white-space:normal;"><a href="about_us.aspx">ABOUT US</a></li>
                            <li style="white-space:normal;"><a href="contact_us.aspx">CONTACT US</a></li>
                            <li style="white-space:normal;"><a href="feedback_2.aspx">FEEDBACK</a></li>
                        </ul>
                    </div>
        ...
        <div class="outer-div">
            ...
            <div class="inner-div1">
                ...
                <p class="content1" style="padding:15px;">Blended with the true essence of Rajasthan this tour is designed in a
