<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bill_page2.aspx.cs" Inherits="musafir_2.bill_page2" %>
        ...
        <div class="container">
             <div class="left">
                   ...
                   <!--  <asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>-->
                     <asp:DropDownList ID="DropDownList1" runat="server" Height="45px" Width="200px">
             </asp:DropDownList>
                     <br />
                     Total Amount
