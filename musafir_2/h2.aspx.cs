...
namespace musafir_2
{
    public partial class h2 : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select hotel , meal from itinerary_final where i_name= 'haridwar-chopta tour package' ", con);
