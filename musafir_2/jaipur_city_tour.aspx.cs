...
namespace musafir_2
{
    public partial class jaipur_city_tour : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select hotel , meal from itinerary_final where i_name= 'jaipur city tour itinerary' ", con);
