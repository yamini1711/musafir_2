...
namespace musafir_2
{
    public partial class n2 : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select hotel , meal from itinerary_final where i_name= 'shridi to trimbakeshwar' ", con);
