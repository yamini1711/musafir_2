<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lonavala_home.aspx.cs" Inherits="musafir_2.lonavala_home" %>
      ...
      <!--  <h1>LONAVALA</h1>-->
        ...
        <div class="conatiner">
            <div class="cards">
             ...
             <div class="cards">
                <div class="cards-img">
                    <img src="images/lonavala.jpeg"  alt="lanavala" />
                    <div class="cards-body">
                        <h3>LONAVALA BUDGET PACKAGEITINERARY</h3>
                        <div class="cards-footer">
                            <button type="submit" formaction="l2.aspx"class="b">VISIT</button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="cards">
                <div class="cards-img">
                    <img src="images/camp%20(1).jpg"   alt="lonavala" />
                    <div class="cards-body">
                        <h3>CAMING IN LONAVALA ITIIERY</h3>
                        <div class="cards-footer">
                            <button type="submit" formaction="l3.aspx"class="b">VISIT</button>
                       </div>
                    </div>
                </div>
            </div>
             <div class="cards">
                <div class="cards-img">
                    <<img src="images/mountain.jpg"  alt="lonavala" />
                    <div class="cards-body">
                        <h3>MAGIC MOUNTAIN LONAVALA ITINERARY</h3>
                        <div class="cards-footer">
                            <button type="submit" formaction="l4.aspx"class="b">VISIT</button>
                        </div>
                    </div>
                </div>
            </div>
