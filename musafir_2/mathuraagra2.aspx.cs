...
namespace musafir_2
{
    public partial class mathuraagra2 : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select hotel , meal from itinerary_final where i_name= 'mathura vrindavan itinerary' ", con);
