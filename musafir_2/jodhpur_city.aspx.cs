...
namespace musafir_2
{
    public partial class jodhpur_city : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select hotel , meal from itinerary_final where i_name= 'jodhpur package' ", con);
