...
namespace musafir_2
{
    public partial class homestay_munnar : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select hotel , meal from itinerary_final where i_name= 'A homestay encircled in munnar' ", con);
