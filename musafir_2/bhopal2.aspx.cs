...
namespace musafir_2
{
    public partial class bhopal2 : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select hotel , meal from itinerary_final where i_name= 'educational tour to chanderi' ", con);
