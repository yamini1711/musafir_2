...
namespace musafir_2
{
    public partial class k3 : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select hotel , meal from itinerary_final where i_name= 'weekned getaway to kochi' ", con);
