...
namespace musafir_2
{
    public partial class rocksportnoida : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select hotel , meal from itinerary_final where i_name= 'day out at rocksport' ", con);
