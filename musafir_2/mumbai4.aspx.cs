...
namespace musafir_2
{
    public partial class mumbai4 : System.Web.UI.Page
    {
        ...
        {
           SqlCommand cmd = new SqlCommand("select hotel , meal from itinerary_final where i_name= 'mumbai night tour' ", con);
