...
namespace musafir_2
{
    public partial class jaisalmer_mountabu : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select hotel , meal from itinerary_final where i_name= 'jaisalmer mountabu' ", con);
