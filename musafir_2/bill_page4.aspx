<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bill_page4.aspx.cs" Inherits="musafir_2.bill_page4" %>
        ...
        <div class="container">
             <div class="left">
                 <form>
                     ...
                     <asp:DropDownList ID="DropDownList1" runat="server" Height="26px" Width="396px"></asp:DropDownList>
                     <br />
                     Total Amount
                   <!--  <asp:TextBox ID="TextBox4" runat="server"></asp:TextBox>-->
                   <!-- <asp:Label ID="Label1" runat="server" Text=""></asp:Label>-->
                     <asp:Label ID="Label2" runat="server" Text="hiii"></asp:Label>
                        </form>   
             </div>
             <div class="right">
                 <br />
                 ...
                 <form>
                     ...
                     <select>
                         ...
                         <br />
                         <br />
                         <asp:Button ID="Button1" runat="server" Text="PAY" Height="44px" Width="71px" OnClick="Button1_Click" />
                         </div>
                 </form>
             </div>
         </div>
